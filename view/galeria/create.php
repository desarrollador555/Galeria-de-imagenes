...
<div class="contenedor">
    <form autocomplete="off" action="index.php?c=galeria&a=PrepararDatos&s=create" class="formulario__galeria__create" method="POST" id="formulario__galeria__create" action="" enctype="multipart/form-data">
        <h2 class="titulo">Subir imagen nueva</h2>
        ...
        <div class="formulario__grupo" id="grupo__titulo">
            ...
            <div class="formulario__grupo__input">
                <input maxlength="100" type="text" class="formulario__input" name="titulo" id="titulo">
        ...
        <div class="formulario__grupo" id="grupo__descripcion">
            ...
            <div class="formulario__grupo__input">
                ...
                <textarea maxlength="300" name="descripcion" class="textarea formulario__input" id="descripcion" cols="30" rows="10"></textarea>
